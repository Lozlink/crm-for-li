...
const DEMO_GUIDED_STOPS: GuidedStop[] = [
  {
    ...
    scoreBreakdown: {
      ...
      total: 82,
      tier: 'hot',
      components: { staleness: 20, salesMomentum: 22, engagement: 18, streetConversion: 12, penetration: 10 },
  ...
  },
  {
    ...
    scoreBreakdown: {
      ...
      total: 65,
      tier: 'warm',
      components: { staleness: 15, salesMomentum: 18, engagement: 14, streetConversion: 10, penetration: 8 },
      lastComputedAt: new Date().toISOString(),
    },
    routePosition: 1,
  ...
  },
  {
    ...
    scoreBreakdown: {
      ...
      total: 54,
      tier: 'warm',
      components: { staleness: 12, salesMomentum: 15, engagement: 12, streetConversion: 8, penetration: 7 },
      lastComputedAt: new Date().toISOString(),
    },
    routePosition: 2,
